...
export declare class VisitorController {
    ...
    securityOverrideStatus(req: AuthRequest, res: Response, next: NextFunction): Promise<void>;
    ...
    getRecentPendingRequests(req: AuthRequest, res: Response, next: NextFunction): Promise<void>;
